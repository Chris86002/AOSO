...
def render(output):
    ...
    draw.text((12, 10), "AOSO OPS HUD / GEOMETRY TEST", fill=green, font=font)
    draw.text((488, 10), "HDG 090", fill=white, font=small)
    draw.text((135, 40), "PITCH +12.0    ROLL -08.0    AoA +03.0", fill=white, font=small)
    out.alpha_composite(glass, (105, 70))
    ...
    draw.text((471, 80), "ALTITUDE", fill=dim, font=small)
    draw.text((483, 107), "10.0km", fill=white, font=font)
    draw.text((483, 134), "AP 80km", fill=green, font=small)
    draw.rectangle((564, 75, 571, 298), outline=dim)
    draw.rectangle((560, 160, 575, 169), fill=green)
    draw.rectangle((105 + 180 - 7, 70 + 120 - 7, 105 + 180 + 7, 70 + 120 + 7), outline=green, width=2)
